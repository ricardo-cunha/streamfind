...
namespace nta
{
    ...
    public:
        ...
        void set_blank_names(std::vector<std::string> b)
        {
            ...
            if (blank_names_.size() < names_.size())
                blank_names_.resize(names_.size());
        }
        void set_replicate_names(std::vector<std::string> r)
        {
            replicate_names_ = std::move(r);
            if (replicate_names_.size() < names_.size())
                replicate_names_.resize(names_.size());
        }
        void set_analysis_indices(std::vector<int> a)
        {
            analysis_indices_ = std::move(a);
            if (analysis_indices_.size() < names_.size())
                analysis_indices_.resize(names_.size(), 0);
        }
...
namespace streamfind::mass_spec::processing_methods
{
    ...
    STREAMFIND_DOMAIN_API Json find_features_with_access(sdk::PluginProjectAccess &access, const Json &parameters);
    STREAMFIND_DOMAIN_API Json load_features_ms1_with_access(sdk::PluginProjectAccess &access, const Json &parameters);
    STREAMFIND_DOMAIN_API Json load_features_ms2_with_access(sdk::PluginProjectAccess &access, const Json &parameters);
    STREAMFIND_DOMAIN_API Json subtract_blank_with_access(sdk::PluginProjectAccess &access, const Json &parameters);
    STREAMFIND_DOMAIN_API Json filter_features_with_access(sdk::PluginProjectAccess &access, const Json &parameters);
    STREAMFIND_DOMAIN_API Json filter_features_ms2_with_access(sdk::PluginProjectAccess &access, const Json &parameters);
    STREAMFIND_DOMAIN_API Json group_features_with_access(sdk::PluginProjectAccess &access, const Json &parameters);
    STREAMFIND_DOMAIN_API Json fill_features_with_access(sdk::PluginProjectAccess &access, const Json &parameters);
    STREAMFIND_DOMAIN_API Json create_components_with_access(sdk::PluginProjectAccess &access, const Json &parameters);
    STREAMFIND_DOMAIN_API Json annotate_components_with_access(sdk::PluginProjectAccess &access, const Json &parameters);
    STREAMFIND_DOMAIN_API Json suspect_screening_with_access(sdk::PluginProjectAccess &access, const Json &parameters);
    STREAMFIND_DOMAIN_API Json find_internal_standards_with_access(sdk::PluginProjectAccess &access, const Json &parameters);
    STREAMFIND_DOMAIN_API Json filter_suspects_with_access(sdk::PluginProjectAccess &access, const Json &parameters);
    STREAMFIND_DOMAIN_API Json filter_internal_standards_with_access(sdk::PluginProjectAccess &access, const Json &parameters);
    STREAMFIND_DOMAIN_API Json correct_matrix_suppression_with_access(sdk::PluginProjectAccess &access, const Json &parameters);
    STREAMFIND_DOMAIN_API Json assign_transformation_products_with_access(sdk::PluginProjectAccess &access, const Json &parameters);
    STREAMFIND_DOMAIN_API Json metfrag_screening_with_access(sdk::PluginProjectAccess &access, const Json &parameters);
